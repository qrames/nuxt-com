  ...
  <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
        <NuxtLink to="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="/public/favicon.ico" class="h-8" alt="Home Logo">
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <!--left button-->
            <button type="button" class="text-amber-950 bg-amber-200 hover:bg-amber-300
                                        focus:ring-4 focus:outline-none focus:ring-amber-100 
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white 
                ...
                <slot name="menu-center">
                    <li>
                        <NuxtLink to="/about" class="block py-2 px-3 text-amber-950 rounded 
                                                    hover:bg-amber-200 md:hover:bg-transparent md:hover:text-amber-300 md:p-0 
                    ...
                    <li>
                        <NuxtLink to="/services" class="block py-2 px-3 text-amber-950 rounded 
                                                        hover:bg-amber-200 md:hover:bg-transparent md:hover:text-amber-300 md:p-0 
                                                        md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 
                                                        dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                            Services
                    ...
                    <li>
                        <NuxtLink to="/Contact" class="block py-2 px-3 text-amber-950 rounded 
                                                        hover:bg-amber-200 md:hover:bg-transparent md:hover:text-amber-300 md:p-0 
                                                        md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 
                                                        dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                            Contact
